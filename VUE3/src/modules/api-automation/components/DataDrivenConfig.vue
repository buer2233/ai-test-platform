<!--
  DataDrivenConfig.vue - 数据驱动测试配置组件

  管理数据驱动测试的数据源，支持以下功能：
  - 统计概览：总数据源数、激活数量、JSON 数据源数量
  - 数据源列表：表格展示，含分页
  - 创建/编辑数据源：
    - 基本信息：名称、项目、关联用例、数据类型、描述
    - 变量映射：将数据列映射到测试变量
    - JSON 数据编辑：直接输入 JSON 数组数据（支持格式化）
    - 数据库配置：MySQL/PostgreSQL/SQLite 连接参数和 SQL 查询
  - 数据预览：展示数据源信息和前 10 条数据
  - 删除数据源（带确认提示）
-->
<template>
