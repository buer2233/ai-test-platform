<!--
  ReportList.vue - 测试报告列表页面

  查看和管理测试执行报告，支持以下功能：
  - 报告表格：执行名称、项目、环境、状态、用例数、通过率、耗时、执行时间、执行人
  - 多维度筛选：按项目、环境、执行状态过滤，按名称搜索
  - 通过率颜色分级：优秀(>=90% 绿色)、良好(>=70% 蓝色)、警告(>=50% 橙色)、差(<50% 红色)
  - 导出功能：单个/批量导出为 JSON 或 Excel 格式
  - 删除功能：单个/批量删除（运行中的报告不可删除）
  - 点击报告名称可跳转至报告详情页
  - 分页：支持自定义每页条数
-->
<template>
