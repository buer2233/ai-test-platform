    ...
    <aside data-testid="main-sidebar" :class="['layout-sidebar', { 'is-collapsed': isCollapse }]">
      ...
      <nav class="sidebar-nav">
        <el-menu
          ...
          class="nav-menu"
        >
          <el-menu-item index="/ui-automation/projects" class="nav-item">
            <el-icon><FolderOpened /></el-icon>
            <template #title>项目管理</template>
          </el-menu-item>

          <el-menu-item index="/ui-automation/test-cases" class="nav-item">
          ...
          <el-menu-item index="/ui-automation/executions" class="nav-item nav-item-accent">
            <el-icon><VideoPlay /></el-icon>
            <template #title>执行监控</template>
          </el-menu-item>

          <el-menu-item index="/ui-automation/reports" class="nav-item">
